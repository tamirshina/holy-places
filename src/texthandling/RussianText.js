...
Со времён распространения христианства на Руси, русский народ ощущает глубокую связь со святыми для христианства местами в Палестине.  Огромные силы и средства вкладываются сюда Российским государством и русским народом. Они направляются, в основном, на строительство церквей и монастырей, а также инфракструктуры для паломников в Иерусалим, число которых растёт с каждым годом. Эти инвестиции были очень важны для развития Палестины. Их результаты чувствуется и в наши дни: прекрасные церкви украшают Израиль, тысячи туристов приезжают ежегодно из России с целью посещения Святых мест. Среди главных строений, построенных ИППО и русской церковью выделяется. `,
  ...
  IsraelPage: {
    haifa: {
      ...
      Особое место в христианстве отводится Илие Пророку, именем которого названа церковь, благодаря его борьбе с идолопоклонством, вершиной которой стала победа Илии на горе Кармель. Согласно христианской традиции, Иоанн Крестититель является духовным приемником Илии Пророка.`,
    },
    seaOfGalili: {
      title: `<b>Тверия</b> `,
  ...
  JerusalemPage: [
    {
      ...
      secTitle: `<b>Церковь Марии Магдалены</b> `,
      cssForPosition: {
        position: "fixed",
        top: "13%",
        right: "21%",
      ...
      info: `Новый Завет характеризует Марию Магдалену как ярую последовательницу Христа и известна как «апостол апостолов» (apostolorum apostola). Согласно Евангелию, она была одной из женщин, присутствовавших на месте распятия и воскрешения Христа.
    ...
    },
    {
      ...
      secTitle: `<b>Александровское подворье, церковь Александра Невского</b>`,
      cssForPosition: {
        position: "fixed",
        top: "38%",
        right: "48%",
      ...
      imageBox: alexBox,
      info: `Единственное в Старом городе Иерусалима  и самое близкое к Храму Гроба Господня русское владение. Представляет собой археологический и архитектурный комплекс, включающий в себя порог Судных Врат со знаменитыми «игольными ушами».
    ...
    },
    {
      ...
      secTitle: `<b>Елионский Спасо-Вознесенский монастырь на Масличной горе</b>`,
      cssForPosition: {
        position: "fixed",
        top: "0%",
        right: "6%",
...
Ученица Иоанна обнаружила голову и вынесла её под покровом ночи из замка. Она спрятала голову в кувшине и похоронила её на Масличной горе. Согласно преданию, голова была найдена дважды. В первый раз – вельможей Иннокентием, решившим удалиться от мира и жить в одиночестве. Он купил небольшой участок земли на Масличной горе. Иннокентий решил построить небольшую церковь и натолкнулся на кувшин с головой. Перед смертью Иннокентий закопал кувшин в том же месте, в котором нашёл его. В 452 г. кувшин был найден двумя монашками, которым Иоанн Креститель трижды явился во сне. Он рассказал им, где похоронена его голова. На третий раз монашки поверили, начали искать и нашли голову.`,
    },
    {
      ...
      secTitle: `<b>Вениаминовское подворье в Иерусалиме</b>`,
      cssForPosition: {
        position: "fixed",
        top: "7%",
        left: "7%",
      ...
      imageBox: benjiBox,
      info: `Названо в честь иеромонаха Вениамина, впервые прибывшего на Святую землю в 1846 г. и влюбившегося в неё подобно многим другим. Во время русско-турецкой войны лечил раненых на фронте и заслужил звание Героя.
  ...
  russianSqure: {
    ...
    itemsArray: [
      ...
      },
      {
        ...
        secTitle: ` <b>Здание духовной миссии</b>`,
        cssForPosition: {
          position: "fixed",
          top: "45%",
          right: "23%",
...
`,
      },
      {
        ...
        secTitle: `<b>Елизаветинское подворье</b>`,
        cssForPosition: {
          position: "fixed",
          top: "47%",
          right: "57%",
        ...
        info: `Построено в 1864 г. архитектором Мартином Ивановичем Эппингером для размещения русских православных паломников-мужчин. Это одноэтажное здание на 300 мест построено в стиле русского Ренессанса. Несмотря на большое количество кроватей, в период с октября до апреля, подворье было заполнено паломниками, дополнительные кровати стояли в коридорах, а палатки разбивали под открытым небом.
      ...
      },
      {
        ...
        secTitle: `<b>Женское общежитеи имени Марии</b> `,
        cssForPosition: {
          position: "fixed",
          top: "15%",
          right: "12%",
        ...
        info: `Общежитие для паломниц, названное в честь Марии Фёдоровны, жены царя Александра Третьего и матери последнего русского царя Николая Второго.
      ...
      },
      {
        ...
        secTitle: `<b>Собор Святой Троицы</b> `,
        cssForPosition: {
          position: "fixed",
          top: "2%",
          left: "61%",
        ...
        info: `Одно из первых строений  принадлежавших Российской империи, часть малого города на «Московской» площади. Собор был спроектирован архитектором Мартином Ивановичем Эппингером.
...
Изначально Собор был построен для паломников, проживающих на Русском подворье. Предполагалось, что паломники будут, в основном, молиться в древних храмах Старого города. Поэтому Собор небольшой, он является самым малым сооружением Русского подворья, однако его высота, расположение и величественный стиль делают его выделяют его на фоне окружающих строений.`,
      },
      {
        ...
        secTitle: `<b>Николаевское подворье</b> `,
        cssForPosition: {
          position: "fixed",
          top: "57%",
          left: "5%",
        ...
        info: `Последнее и самое большое общежитие для паломников, построенное ИППО в Иерусалиме и названное в честь последнего русского царя Николая Второго. Здание спроектировано питербургским архитектором А.Е. Элкиным. На подворье есть 1200 мест трёх разных классов. Места третьего класса стоили 13 копеек за ночь, места второго класса – 2 рубля за ночь, места  первого класса – 4 рубля за ночь.
...
`,
      },
      {
        ...
        secTitle: `<b>Сергиевское подворье</b> `,
        cssForPosition: {
          position: "fixed",
          top: "9%",
          left: "14%",
        ...
        imageBox: benjiBox,
        info: `Обитель расчитана на 418 человек, 25 из её комнат рассчитаны на более привередливых гостей и оформлены в стиле западных гостиниц. 
